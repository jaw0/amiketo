...
<library name="jaw">
<packages>
<package name="M05-1X12-RA">
<description>http://www.molex.com/pdm_docs/sd/5034801200_sd.pdf</description>
<smd name="P6" x="-0.25" y="0.4" dx="0.3" dy="0.8" layer="1"/>
<smd name="P7" x="0.25" y="0.4" dx="0.3" dy="0.8" layer="1"/>
<smd name="P5" x="-0.75" y="0.4" dx="0.3" dy="0.8" layer="1"/>
<smd name="P4" x="-1.25" y="0.4" dx="0.3" dy="0.8" layer="1"/>
<smd name="P8" x="0.75" y="0.4" dx="0.3" dy="0.8" layer="1"/>
<smd name="P9" x="1.25" y="0.4" dx="0.3" dy="0.8" layer="1"/>
<smd name="P3" x="-1.75" y="0.4" dx="0.3" dy="0.8" layer="1"/>
<smd name="P2" x="-2.25" y="0.4" dx="0.3" dy="0.8" layer="1"/>
<smd name="P1" x="-2.75" y="0.4" dx="0.3" dy="0.8" layer="1"/>
<smd name="P10" x="1.75" y="0.4" dx="0.3" dy="0.8" layer="1"/>
<smd name="P11" x="2.25" y="0.4" dx="0.3" dy="0.8" layer="1"/>
<smd name="P12" x="2.75" y="0.4" dx="0.3" dy="0.8" layer="1"/>
<smd name="P$13" x="3.55" y="-2.25" dx="0.3" dy="1" layer="1"/>
<smd name="P$14" x="-3.55" y="-2.25" dx="0.3" dy="1" layer="1"/>
<wire x1="-4" y1="1" x2="4" y2="1" width="0.1" layer="21"/>
<wire x1="4" y1="1" x2="4" y2="-3" width="0.1" layer="21"/>
<wire x1="4" y1="-3" x2="3.2" y2="-3" width="0.1" layer="21"/>
<wire x1="3.2" y1="-3" x2="-3.2" y2="-3" width="0.1" layer="21"/>
<wire x1="-3.2" y1="-3" x2="-4" y2="-3" width="0.1" layer="21"/>
<wire x1="-4" y1="-3" x2="-4" y2="1" width="0.1" layer="21"/>
<wire x1="-3.2" y1="-3" x2="-3.2" y2="-3.4" width="0.1" layer="21"/>
<wire x1="3.2" y1="-3" x2="3.2" y2="-3.4" width="0.1" layer="21"/>
<wire x1="-3.2" y1="-3.8" x2="-3.2" y2="-4.2" width="0.1" layer="21"/>
<wire x1="-3.2" y1="-4.6" x2="-3.2" y2="-5" width="0.1" layer="21"/>
<wire x1="3.2" y1="-3.8" x2="3.2" y2="-4.2" width="0.1" layer="21"/>
<wire x1="3.2" y1="-4.6" x2="3.2" y2="-5" width="0.1" layer="21"/>
...
<text x="-1.778" y="-2.286" size="1.27" layer="27" font="vector" ratio="10">&gt;VALUE</text>
...
<symbol name="MA-12-1">
<pin name="P6" x="-7.62" y="0" visible="pin" length="middle"/>
<pin name="P5" x="-7.62" y="2.54" visible="pin" length="middle"/>
<pin name="P4" x="-7.62" y="5.08" visible="pin" length="middle"/>
<pin name="P3" x="-7.62" y="7.62" visible="pin" length="middle"/>
<pin name="P2" x="-7.62" y="10.16" visible="pin" length="middle"/>
<pin name="P1" x="-7.62" y="12.7" visible="pin" length="middle"/>
<pin name="P7" x="-7.62" y="-2.54" visible="pin" length="middle"/>
<pin name="P8" x="-7.62" y="-5.08" visible="pin" length="middle"/>
<pin name="P9" x="-7.62" y="-7.62" visible="pin" length="middle"/>
<pin name="P10" x="-7.62" y="-10.16" visible="pin" length="middle"/>
<pin name="P11" x="-7.62" y="-12.7" visible="pin" length="middle"/>
<pin name="P12" x="-7.62" y="-15.24" visible="pin" length="middle"/>
...
<gates>
<gate name="G$1" symbol="MA-12-1" x="-2.54" y="0"/>
</gates>
<devices>
<device name="" package="M05-1X12-RA">
<connects>
...
<part name="CN2" library="jaw" deviceset="MA12-1" device=""/>
...
<sheet>
<plain>
<text x="121.92" y="22.86" size="1.778" layer="97">P8,P9 = BS0,BS1
 =&gt; 4wire SPI
(CFAL docs say 11, SSD says 00)</text>
<text x="27.94" y="68.58" size="2.54" layer="97">crystalfontz 128x32 OLED</text>
</plain>
<instances>
...
<instance part="CN2" gate="G$1" x="111.76" y="33.02"/>
